...
const Friend = props => (
  <a className={s.friendLink} href={props.url}>
    <svg
    ...
    <span className={s.friendName}>{props.friendName}</span>
  </a>
)
  ...
  return (
    <footer className={s.footer}>
      ...
      <div className={s.friends}>
        ...
        <Friend
          friendLink="https://singaporecss.github.io"
          friendName="SingaporeCSS"
        />
        <Friend
          friendLink="https://www.meetup.com/React-Singapore/"
          friendName="ReactJS Singapore"
        />
        <Friend
          friendLink="https://www.meetup.com/JAMstack-Singapore/"
          friendName="JamStack Singapore"
        />
      </div>
    </footer>
  )
