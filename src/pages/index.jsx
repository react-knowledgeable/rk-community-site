        ...
        <Card>
          ...
          {talks.map(
            ({
              title: talkTitle,
              body: talkBody,
              author: { avatarUrl: authorAvatar, url: authorUrl },
              reactions: { totalCount: hotness },
              url: issueUrl,
            }) => (
              <Talk
                {...{
      ...
      <aside>
        ...
        <Card>
          ...
          <div className={s.reachingOutList}>
            ...
            <div className={s.reachingOutItem}>
              <a href="https://meetup.com/React-Knowledgeable">{title}</a>
            </div>
          </div>
        </Card>
      </aside>
  ...
  query HomePageQuery {
    ...
    talks: github {
      repository(owner: "react-knowledgeable", name: "talks") {
        issues(first: 100, labels: ["talk"], states: [OPEN]) {
          nodes {
            title
            body
            author {
